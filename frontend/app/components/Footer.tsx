      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="font-display text-2xl font-bold mb-4">E-Shop</h3>
            <p className="text-gray-400 mb-6 max-w-md">
              Your destination for premium products. Experience luxury shopping with secure checkout and fast delivery.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display text-lg font-semibold mb-4 uppercase tracking-wider">Quick Links</h4>
          ...
          {/* Help */}
          <div>
            <h4 className="font-display text-lg font-semibold mb-4 uppercase tracking-wider">Help</h4>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">
                  Track Order
